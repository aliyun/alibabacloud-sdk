...
namespace AlibabaCloud\SDK\Facebody\V20191230\Facebody\DetectLivingFaceResponse;
        ...
        if (isset($map['Elements'])) {
            if (!empty($map['Elements'])) {
                ...
                foreach ($map['Elements'] as $item) {
                    $model->elements[$n++] = null !== $item ? DetectLivingFaceResponse\data\elements::fromMap($item) : $item;
                }
            }
        }
