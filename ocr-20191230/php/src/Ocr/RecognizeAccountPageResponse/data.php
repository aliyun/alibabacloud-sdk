...
use AlibabaCloud\SDK\Ocr\V20191230\Ocr\data\titleArea;
        ...
        if (isset($map['InvalidStampAreas'])) {
            if (!empty($map['InvalidStampAreas'])) {
                ...
                foreach ($map['InvalidStampAreas'] as $item) {
                    $model->invalidStampAreas[$n++] = null !== $item ? RecognizeAccountPageResponse\data\invalidStampAreas::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['UndertakeStampAreas'])) {
            if (!empty($map['UndertakeStampAreas'])) {
                ...
                foreach ($map['UndertakeStampAreas'] as $item) {
                    $model->undertakeStampAreas[$n++] = null !== $item ? RecognizeAccountPageResponse\data\undertakeStampAreas::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['RegisterStampAreas'])) {
            if (!empty($map['RegisterStampAreas'])) {
                ...
                foreach ($map['RegisterStampAreas'] as $item) {
                    $model->registerStampAreas[$n++] = null !== $item ? RecognizeAccountPageResponse\data\registerStampAreas::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['OtherStampAreas'])) {
            if (!empty($map['OtherStampAreas'])) {
                ...
                foreach ($map['OtherStampAreas'] as $item) {
                    $model->otherStampAreas[$n++] = null !== $item ? RecognizeAccountPageResponse\data\otherStampAreas::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['TitleArea'])) {
            $model->titleArea = data\titleArea::fromMap($map['TitleArea']);
        }
