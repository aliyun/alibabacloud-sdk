...
namespace AlibabaCloud\SDK\Ocr\V20191230\Ocr\RecognizeQrCodeResponse;
        ...
        if (isset($map['Elements'])) {
            if (!empty($map['Elements'])) {
                ...
                foreach ($map['Elements'] as $item) {
                    $model->elements[$n++] = null !== $item ? RecognizeQrCodeResponse\data\elements::fromMap($item) : $item;
                }
            }
        }
