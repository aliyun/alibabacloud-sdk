...
namespace AlibabaCloud\SDK\Ocr\V20191230\Ocr\RecognizeTakeoutOrderResponse;
        ...
        if (isset($map['Elements'])) {
            if (!empty($map['Elements'])) {
                ...
                foreach ($map['Elements'] as $item) {
                    $model->elements[$n++] = null !== $item ? RecognizeTakeoutOrderResponse\data\elements::fromMap($item) : $item;
                }
            }
        }
