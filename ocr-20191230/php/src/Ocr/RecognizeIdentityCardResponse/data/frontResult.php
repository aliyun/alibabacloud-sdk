...
use AlibabaCloud\SDK\Ocr\V20191230\Ocr\frontResult\faceRectangle;
        ...
        if (isset($map['CardAreas'])) {
            if (!empty($map['CardAreas'])) {
                ...
                foreach ($map['CardAreas'] as $item) {
                    $model->cardAreas[$n++] = null !== $item ? RecognizeIdentityCardResponse\data\frontResult\cardAreas::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['FaceRectVertices'])) {
            if (!empty($map['FaceRectVertices'])) {
                ...
                foreach ($map['FaceRectVertices'] as $item) {
                    $model->faceRectVertices[$n++] = null !== $item ? RecognizeIdentityCardResponse\data\frontResult\faceRectVertices::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['FaceRectangle'])) {
            $model->faceRectangle = frontResult\faceRectangle::fromMap($map['FaceRectangle']);
        }
