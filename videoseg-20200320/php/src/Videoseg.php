...
use AlibabaCloud\SDK\Videoseg\V20200320\Videoseg\Config;
use AlibabaCloud\SDK\Videoseg\V20200320\Videoseg\GetAsyncJobResultRequest;
use AlibabaCloud\SDK\Videoseg\V20200320\Videoseg\GetAsyncJobResultResponse;
...
class Videoseg
{
    ...
    public function _request($action, $protocol, $method, $authType, $query, $body, RuntimeOptions $runtime)
    {
        ...
        while (Tea::allowRetry($_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->headers = [
                    'host'       => RpcUtils::getHost('videoseg', $this->_regionId, $this->_endpoint),
    ...
    {
        return Model::toModel($this->_request('SegmentVideoBody', 'HTTPS', 'POST', 'AK', null, $request, $runtime), new SegmentVideoBodyResponse());
    }
