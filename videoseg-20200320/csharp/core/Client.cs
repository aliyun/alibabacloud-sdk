...
namespace AlibabaCloud.SDK.Videoseg20200320
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public SegmentHalfBodyResponse SegmentHalfBody(SegmentHalfBodyRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SegmentHalfBodyResponse>(DoRequest("SegmentHalfBody", "HTTPS", "POST", "2020-03-20", "AK", null, request.ToMap(), runtime));
        }

        public async Task<SegmentHalfBodyResponse> SegmentHalfBodyAsync(SegmentHalfBodyRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SegmentHalfBodyResponse>(await DoRequestAsync("SegmentHalfBody", "HTTPS", "POST", "2020-03-20", "AK", null, request.ToMap(), runtime));
        }
        ...
        public SegmentHalfBodyResponse SegmentHalfBodyAdvance(SegmentHalfBodyAdvanceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            AlibabaCloud.Commons.Common.Convert(request, segmentHalfBodyreq);
            segmentHalfBodyreq.VideoUrl = "http://" + authResponse.Bucket + "." + authResponse.Endpoint + "/" + authResponse.ObjectKey;
            SegmentHalfBodyResponse segmentHalfBodyResp = SegmentHalfBody(segmentHalfBodyreq, runtime);
        ...
        public async Task<SegmentHalfBodyResponse> SegmentHalfBodyAdvanceAsync(SegmentHalfBodyAdvanceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            AlibabaCloud.Commons.Common.Convert(request, segmentHalfBodyreq);
            segmentHalfBodyreq.VideoUrl = "http://" + authResponse.Bucket + "." + authResponse.Endpoint + "/" + authResponse.ObjectKey;
            SegmentHalfBodyResponse segmentHalfBodyResp = await SegmentHalfBodyAsync(segmentHalfBodyreq, runtime);
            return segmentHalfBodyResp;
        }
