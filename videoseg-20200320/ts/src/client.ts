...
export class SegmentHalfBodyResponse extends $tea.Model {
  requestId: string;
  data: SegmentHalfBodyResponseData;
  static names(): { [key: string]: string } {
    return {
      requestId: 'RequestId',
      data: 'Data',
...
export class SegmentHalfBodyResponseData extends $tea.Model {
  videoUrl: string;
  static names(): { [key: string]: string } {
    return {
      videoUrl: 'VideoUrl',
...
export default class Client extends RPC {
  ...
  async segmentHalfBody(request: SegmentHalfBodyRequest, runtime: $Util.RuntimeOptions): Promise<SegmentHalfBodyResponse> {
    Util.validateModel(request);
    return $tea.cast<SegmentHalfBodyResponse>(await this.doRequest("SegmentHalfBody", "HTTPS", "POST", "2020-03-20", "AK", null, $tea.toMap(request), runtime), new SegmentHalfBodyResponse({}));
  }
  ...
  async segmentHalfBodyAdvance(request: SegmentHalfBodyAdvanceRequest, runtime: $Util.RuntimeOptions): Promise<SegmentHalfBodyResponse> {
    ...
    let segmentHalfBodyResp = await this.segmentHalfBody(segmentHalfBodyreq, runtime);
