...
class Client(RPCClient):
    ...
    def segment_video_body(self, request, runtime):
        UtilClient.validate_model(request)
        return videoseg_20200320_models.SegmentVideoBodyResponse().from_map(self.do_request("SegmentVideoBody", "HTTPS", "POST", "2020-03-20", "AK", None, request.to_map(), runtime))
    ...
    def get_async_job_result(self, request, runtime):
        UtilClient.validate_model(request)
        return videoseg_20200320_models.GetAsyncJobResultResponse().from_map(self.do_request("GetAsyncJobResult", "HTTPS", "POST", "2020-03-20", "AK", None, request.to_map(), runtime))
