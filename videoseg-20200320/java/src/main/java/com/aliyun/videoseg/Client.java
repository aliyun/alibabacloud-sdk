...
package com.aliyun.videoseg;

import com.aliyun.tea.*;
import com.aliyun.videoseg.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.headers = TeaConverter.buildMap(
                    new TeaPair("host", com.aliyun.common.Common.getHost("videoseg", _regionId, _endpoint)),
    ...
    public SegmentVideoBodyResponse segmentVideoBody(SegmentVideoBodyRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("SegmentVideoBody", "HTTPS", "POST", "AK", null, TeaModel.buildMap(request), runtime), new SegmentVideoBodyResponse());
    }
