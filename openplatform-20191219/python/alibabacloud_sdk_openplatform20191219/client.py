...
from alibabacloud_sdk_openplatform20191219 import models as open_platform_20191219_models
...
class Client(RPCClient):
    ...
    def authorize_file_upload_with_options(self, request, runtime):
        ...
        return open_platform_20191219_models.AuthorizeFileUploadResponse().from_map(self.do_request("AuthorizeFileUpload", "HTTPS", "GET", "2019-12-19", "AK", request.to_map(), None, runtime))
