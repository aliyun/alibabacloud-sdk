...
namespace AlibabaCloud.Imageseg
{
    public class Client 
    {
        ...
        {
            return TeaModel.ToObject<ParseFaceResponse>(_request("ParseFace", "HTTPS", "GET", request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<ParseFaceResponse>(await _requestAsync("ParseFace", "HTTPS", "GET", request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<SegmentVehicleResponse>(_request("SegmentVehicle", "HTTPS", "POST", request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<SegmentVehicleResponse>(await _requestAsync("SegmentVehicle", "HTTPS", "POST", request.ToMap(), runtime));
        }
