...
namespace AlibabaCloud\SDK\Imageseg\V20191230\Imageseg\SegmentHairResponse;
        ...
        if (isset($map['Elements'])) {
            if (!empty($map['Elements'])) {
                ...
                foreach ($map['Elements'] as $item) {
                    $model->elements[$n++] = null !== $item ? SegmentHairResponse\data\elements::fromMap($item) : $item;
                }
            }
        }
