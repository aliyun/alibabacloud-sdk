...
using AlibabaCloud.Videoseg.Models;
...
namespace AlibabaCloud.Videoseg
{
    public class Client 
    {
        ...
        public Dictionary<string, object> _request(string action, string protocol, string method, string authType, Dictionary<string, object> query, Dictionary<string, object> body, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            while (TeaCore.AllowRetry((IDictionary) runtime_["retry"], _retryTimes, _now))
            {
                ...
                try
                {
                    ...
                    {
                        {"host", AlibabaCloud.Commons.Common.GetHost("videoseg", _regionId, _endpoint)},
        ...
        {
            return TeaModel.ToObject<SegmentVideoBodyResponse>(_request("SegmentVideoBody", "HTTPS", "POST", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<SegmentVideoBodyResponse>(await _requestAsync("SegmentVideoBody", "HTTPS", "POST", "AK", null, request.ToMap(), runtime));
        }
