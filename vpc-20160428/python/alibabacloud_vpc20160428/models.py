    ...
    def from_map(self, map={}):
        ...
        if map.get('MetricDataList') is not None:
            for k in map.get('MetricDataList'):
                ...
                self.metric_data_list.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('AssociateVpcs') is not None:
            for k in map.get('AssociateVpcs'):
                ...
                temp_model = temp_model.from_map(k)
                self.associate_vpcs.append(temp_model)
        else:
...
class ListDhcpOptionsSetsRequest(TeaModel):
    ...
    def to_map(self):
        ...
        result['MaxResults'] = self.max_results
        result['DomainName'] = self.domain_name
        result['DhcpOptionsSetId'] = []
        if self.dhcp_options_set_id is not None:
            for k in self.dhcp_options_set_id:
                result['DhcpOptionsSetId'].append(k)
        else:
            result['DhcpOptionsSetId'] = None
        result['DhcpOptionsSetName'] = self.dhcp_options_set_name
        return result
    ...
    def from_map(self, map={}):
        ...
        self.max_results = map.get('MaxResults')
        self.domain_name = map.get('DomainName')
        self.dhcp_options_set_id = []
        if map.get('DhcpOptionsSetId') is not None:
            for k in map.get('DhcpOptionsSetId'):
                self.dhcp_options_set_id.append(k)
        else:
            self.dhcp_options_set_id = None
        self.dhcp_options_set_name = map.get('DhcpOptionsSetName')
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('DhcpOptionsSets') is not None:
            for k in map.get('DhcpOptionsSets'):
                ...
                temp_model = temp_model.from_map(k)
                self.dhcp_options_sets.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('EipSegment') is not None:
            for k in map.get('EipSegment'):
                ...
                temp_model = temp_model.from_map(k)
                self.eip_segment.append(temp_model)
        else:
...
class AllocateEipSegmentAddressRequest(TeaModel):
    def __init__(self, client_token=None, bandwidth=None, region_id=None, eip_mask=None, netmode=None,
                 internet_charge_type=None, resource_group_id=None):
        self.client_token = client_token
    ...
    def from_map(self, map={}):
        ...
        if map.get('EipInfo') is not None:
            for k in map.get('EipInfo'):
                ...
                temp_model = temp_model.from_map(k)
                self.eip_info.append(temp_model)
        else:
            self.eip_info = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('VirtualBorderRouterModel') is not None:
            for k in map.get('VirtualBorderRouterModel'):
                ...
                temp_model = temp_model.from_map(k)
                self.virtual_border_router_model.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('ExpressCloudConnectionType') is not None:
            for k in map.get('ExpressCloudConnectionType'):
                ...
                temp_model = temp_model.from_map(k)
                self.express_cloud_connection_type.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('IngressAclEntries') is not None:
            for k in map.get('IngressAclEntries'):
                ...
                temp_model = temp_model.from_map(k)
                self.ingress_acl_entries.append(temp_model)
        else:
        ...
        if map.get('EgressAclEntries') is not None:
            for k in map.get('EgressAclEntries'):
                ...
                temp_model = temp_model.from_map(k)
                self.egress_acl_entries.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('IngressAclEntry') is not None:
            for k in map.get('IngressAclEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.ingress_acl_entry.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('EgressAclEntry') is not None:
            for k in map.get('EgressAclEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.egress_acl_entry.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('NetworkAcl') is not None:
            for k in map.get('NetworkAcl'):
                ...
                temp_model = temp_model.from_map(k)
                self.network_acl.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('VpnRouteEntry') is not None:
            for k in map.get('VpnRouteEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.vpn_route_entry.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('VpnPbrRouteEntry') is not None:
            for k in map.get('VpnPbrRouteEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.vpn_pbr_route_entry.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('NextHop') is not None:
            for k in map.get('NextHop'):
                ...
                temp_model = temp_model.from_map(k)
                self.next_hop.append(temp_model)
        else:
            self.next_hop = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('RouteEntry') is not None:
            for k in map.get('RouteEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.route_entry.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('IPv6TranslatorAcl') is not None:
            for k in map.get('IPv6TranslatorAcl'):
                ...
                temp_model = temp_model.from_map(k)
                self.ipv_6translator_acl.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('AclEntry') is not None:
            for k in map.get('AclEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.acl_entry.append(temp_model)
        else:
            self.acl_entry = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('Ipv6Gateway') is not None:
            for k in map.get('Ipv6Gateway'):
                ...
                temp_model = temp_model.from_map(k)
                self.ipv_6gateway.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('Ipv6EgressOnlyRule') is not None:
            for k in map.get('Ipv6EgressOnlyRule'):
                ...
                temp_model = temp_model.from_map(k)
                self.ipv_6egress_only_rule.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('Ipv6Address') is not None:
            for k in map.get('Ipv6Address'):
                ...
                temp_model = temp_model.from_map(k)
                self.ipv_6address.append(temp_model)
        else:
...
class DescribeIPv6TranslatorsResponseIpv6TranslatorsIpv6TranslatorIpv6TranslatorEntryIds(TeaModel):
    ...
    def to_map(self):
        result = {}
        result['Ipv6TranslatorEntryId'] = []
        if self.ipv_6translator_entry_id is not None:
            for k in self.ipv_6translator_entry_id:
                result['Ipv6TranslatorEntryId'].append(k)
        else:
            result['Ipv6TranslatorEntryId'] = None
        return result

    def from_map(self, map={}):
        self.ipv_6translator_entry_id = []
        if map.get('Ipv6TranslatorEntryId') is not None:
            for k in map.get('Ipv6TranslatorEntryId'):
                self.ipv_6translator_entry_id.append(k)
        else:
            self.ipv_6translator_entry_id = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('Ipv6Translator') is not None:
            for k in map.get('Ipv6Translator'):
                ...
                temp_model = temp_model.from_map(k)
                self.ipv_6translator.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('Ipv6TranslatorEntry') is not None:
            for k in map.get('Ipv6TranslatorEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.ipv_6translator_entry.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('FlowLog') is not None:
            for k in map.get('FlowLog'):
                ...
                temp_model = temp_model.from_map(k)
                self.flow_log.append(temp_model)
        else:
            self.flow_log = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('CbnGrantRule') is not None:
            for k in map.get('CbnGrantRule'):
                ...
                temp_model = temp_model.from_map(k)
                self.cbn_grant_rule.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('SslVpnServer') is not None:
            for k in map.get('SslVpnServer'):
                ...
                temp_model = temp_model.from_map(k)
                self.ssl_vpn_server.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('SslVpnClientCertKey') is not None:
            for k in map.get('SslVpnClientCertKey'):
                ...
                temp_model = temp_model.from_map(k)
                self.ssl_vpn_client_cert_key.append(temp_model)
        else:
...
class DescribeRouteTableListResponseRouterTableListRouterTableListTypeVSwitchIds(TeaModel):
    ...
    def to_map(self):
        ...
        if self.v_switch_id is not None:
            for k in self.v_switch_id:
                result['VSwitchId'].append(k)
        else:
            result['VSwitchId'] = None
        return result

    def from_map(self, map={}):
        self.v_switch_id = []
        if map.get('VSwitchId') is not None:
            for k in map.get('VSwitchId'):
                self.v_switch_id.append(k)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('RouterTableListType') is not None:
            for k in map.get('RouterTableListType'):
                ...
                temp_model = temp_model.from_map(k)
                self.router_table_list_type.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('BgpNetwork') is not None:
            for k in map.get('BgpNetwork'):
                ...
                temp_model = temp_model.from_map(k)
                self.bgp_network.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('GlobalAccelerationInstance') is not None:
            for k in map.get('GlobalAccelerationInstance'):
                ...
                temp_model = temp_model.from_map(k)
                self.global_acceleration_instance.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('BackendServer') is not None:
            for k in map.get('BackendServer'):
                ...
                temp_model = temp_model.from_map(k)
                self.backend_server.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('PublicIpAddress') is not None:
            for k in map.get('PublicIpAddress'):
                ...
                temp_model = temp_model.from_map(k)
                self.public_ip_address.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('CommonBandwidthPackage') is not None:
            for k in map.get('CommonBandwidthPackage'):
                ...
                temp_model = temp_model.from_map(k)
                self.common_bandwidth_package.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('VpnGateway') is not None:
            for k in map.get('VpnGateway'):
                ...
                temp_model = temp_model.from_map(k)
                self.vpn_gateway.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('VpnConnection') is not None:
            for k in map.get('VpnConnection'):
                ...
                temp_model = temp_model.from_map(k)
                self.vpn_connection.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('CustomerGateway') is not None:
            for k in map.get('CustomerGateway'):
                ...
                temp_model = temp_model.from_map(k)
                self.customer_gateway.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('BgpPeer') is not None:
            for k in map.get('BgpPeer'):
                ...
                temp_model = temp_model.from_map(k)
                self.bgp_peer.append(temp_model)
        else:
            self.bgp_peer = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('BgpGroup') is not None:
            for k in map.get('BgpGroup'):
                ...
                temp_model = temp_model.from_map(k)
                self.bgp_group.append(temp_model)
        else:
            self.bgp_group = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('AssociatedCen') is not None:
            for k in map.get('AssociatedCen'):
                ...
                temp_model = temp_model.from_map(k)
                self.associated_cen.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('CloudResourceSetType') is not None:
            for k in map.get('CloudResourceSetType'):
                ...
                temp_model = temp_model.from_map(k)
                self.cloud_resource_set_type.append(temp_model)
        else:
...
class DescribeVpcAttributeResponseUserCidrs(TeaModel):
    ...
    def to_map(self):
        ...
        if self.user_cidr is not None:
            for k in self.user_cidr:
                result['UserCidr'].append(k)
        else:
            result['UserCidr'] = None
        return result

    def from_map(self, map={}):
        self.user_cidr = []
        if map.get('UserCidr') is not None:
            for k in map.get('UserCidr'):
                self.user_cidr.append(k)
        else:
            self.user_cidr = None
        return self
...
class DescribeVpcAttributeResponseSecondaryCidrBlocks(TeaModel):
    ...
    def to_map(self):
        result = {}
        result['SecondaryCidrBlock'] = []
        if self.secondary_cidr_block is not None:
            for k in self.secondary_cidr_block:
                result['SecondaryCidrBlock'].append(k)
        else:
            result['SecondaryCidrBlock'] = None
        return result

    def from_map(self, map={}):
        self.secondary_cidr_block = []
        if map.get('SecondaryCidrBlock') is not None:
            for k in map.get('SecondaryCidrBlock'):
                self.secondary_cidr_block.append(k)
        else:
            self.secondary_cidr_block = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('SnatTableEntry') is not None:
            for k in map.get('SnatTableEntry'):
                ...
                temp_model = temp_model.from_map(k)
                self.snat_table_entry.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('VSwitch') is not None:
            for k in map.get('VSwitch'):
                ...
                temp_model = temp_model.from_map(k)
                self.v_switch.append(temp_model)
        else:
            self.v_switch = None
        return self
...
class DescribeVRoutersResponseVRoutersVRouterRouteTableIds(TeaModel):
    ...
    def to_map(self):
        ...
        if self.route_table_id is not None:
            for k in self.route_table_id:
                result['RouteTableId'].append(k)
        else:
            result['RouteTableId'] = None
        return result

    def from_map(self, map={}):
        self.route_table_id = []
        if map.get('RouteTableId') is not None:
            for k in map.get('RouteTableId'):
                self.route_table_id.append(k)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('VRouter') is not None:
            for k in map.get('VRouter'):
                ...
                temp_model = temp_model.from_map(k)
                self.vrouter.append(temp_model)
        else:
            self.vrouter = None
        return self
...
class DescribeVpcsResponseVpcsVpcNatGatewayIds(TeaModel):
    ...
    def to_map(self):
        ...
        if self.nat_gateway_ids is not None:
            for k in self.nat_gateway_ids:
                result['NatGatewayIds'].append(k)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('NatGatewayIds') is not None:
            for k in map.get('NatGatewayIds'):
                self.nat_gateway_ids.append(k)
        else:
...
class DescribeVpcsResponseVpcsVpcRouterTableIds(TeaModel):
    ...
    def to_map(self):
        result = {}
        result['RouterTableIds'] = []
        if self.router_table_ids is not None:
            for k in self.router_table_ids:
                result['RouterTableIds'].append(k)
        else:
            result['RouterTableIds'] = None
        return result

    def from_map(self, map={}):
        self.router_table_ids = []
        if map.get('RouterTableIds') is not None:
            for k in map.get('RouterTableIds'):
                self.router_table_ids.append(k)
        else:
...
class DescribeVirtualBorderRoutersResponseVirtualBorderRouterSetVirtualBorderRouterTypeAssociatedPhysicalConnectionsAssociatedPhysicalConnection(TeaModel):
    def __init__(self, circuit_code=None, vlan_interface_id=None, local_gateway_ip=None, peer_gateway_ip=None,
                 ...
                 peer_ipv_6gateway_ip=None, peering_ipv_6subnet_mask=None, status=None):
        self.circuit_code = circuit_code
    ...
    def from_map(self, map={}):
        ...
        if map.get('AssociatedPhysicalConnection') is not None:
            for k in map.get('AssociatedPhysicalConnection'):
                ...
                temp_model = temp_model.from_map(k)
                self.associated_physical_connection.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('RouteTable') is not None:
            for k in map.get('RouteTable'):
                ...
                temp_model = temp_model.from_map(k)
                self.route_table.append(temp_model)
        else:
            self.route_table = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('IpList') is not None:
            for k in map.get('IpList'):
                ...
                temp_model = temp_model.from_map(k)
                self.ip_list.append(temp_model)
        else:
            self.ip_list = None
        return self
...
class DescribeNatGatewaysResponseNatGatewaysNatGatewaySnatTableIds(TeaModel):
    ...
    def to_map(self):
        ...
        if self.snat_table_id is not None:
            for k in self.snat_table_id:
                result['SnatTableId'].append(k)
        else:
            result['SnatTableId'] = None
        return result

    def from_map(self, map={}):
        self.snat_table_id = []
        if map.get('SnatTableId') is not None:
            for k in map.get('SnatTableId'):
                self.snat_table_id.append(k)
        else:
            self.snat_table_id = None
        return self
    ...
    def from_map(self, map={}):
        ...
        if map.get('LockReason') is not None:
            for k in map.get('LockReason'):
                ...
                temp_model = temp_model.from_map(k)
                self.lock_reason.append(temp_model)
        else:
    ...
    def to_map(self):
        ...
        if self.available_region is not None:
            for k in self.available_region:
                result['AvailableRegion'].append(k)
        else:
            result['AvailableRegion'] = None
        return result

    def from_map(self, map={}):
        self.available_region = []
        if map.get('AvailableRegion') is not None:
            for k in map.get('AvailableRegion'):
                self.available_region.append(k)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('EipAddress') is not None:
            for k in map.get('EipAddress'):
                ...
                temp_model = temp_model.from_map(k)
                self.eip_address.append(temp_model)
        else:
    ...
    def from_map(self, map={}):
        ...
        if map.get('NextHopList') is not None:
            for k in map.get('NextHopList'):
                ...
                temp_model = temp_model.from_map(k)
                self.next_hop_list.append(temp_model)
        else:
