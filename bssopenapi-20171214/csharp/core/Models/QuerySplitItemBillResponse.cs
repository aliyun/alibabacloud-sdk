...
{
    public class QuerySplitItemBillResponse : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=true)]
        public QuerySplitItemBillResponseData Data { get; set; }
        public class QuerySplitItemBillResponseData : TeaModel {
            ...
            [NameInMap("Items")]
            [Validation(Required=true)]
            public QuerySplitItemBillResponseDataItems Items { get; set; }
            public class QuerySplitItemBillResponseDataItems : TeaModel {
                [NameInMap("Item")]
                [Validation(Required=true)]
                public List<QuerySplitItemBillResponseDataItemsItem> Item { get; set; }
                public class QuerySplitItemBillResponseDataItemsItem : TeaModel {
