...
namespace AlibabaCloud\SDK\Objectdet\V20191230\Objectdet\RecognizeVehiclePartsResponse;
        ...
        if (isset($map['Elements'])) {
            if (!empty($map['Elements'])) {
                ...
                foreach ($map['Elements'] as $item) {
                    $model->elements[$n++] = null !== $item ? RecognizeVehiclePartsResponse\data\elements::fromMap($item) : $item;
                }
            }
        }
