...
use AlibabaCloud\SDK\Cms\V20190101\Models\DescribeCustomEventCountResponse\customEventCounts;
...
class DescribeCustomEventCountResponse extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('customEventCounts', $this->customEventCounts, true);
    }
