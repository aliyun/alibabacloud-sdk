        ...
        if (isset($map['EnvironmentVar'])) {
            if (!empty($map['EnvironmentVar'])) {
                ...
                foreach ($map['EnvironmentVar'] as $item) {
                    $model->environmentVar[$n++] = null !== $item ? UpdateContainerGroupRequest\initContainer\environmentVar::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Port'])) {
            if (!empty($map['Port'])) {
                ...
                foreach ($map['Port'] as $item) {
                    $model->port[$n++] = null !== $item ? UpdateContainerGroupRequest\initContainer\port::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['VolumeMount'])) {
            if (!empty($map['VolumeMount'])) {
                ...
                foreach ($map['VolumeMount'] as $item) {
                    $model->volumeMount[$n++] = null !== $item ? UpdateContainerGroupRequest\initContainer\volumeMount::fromMap($item) : $item;
                }
            }
        }
