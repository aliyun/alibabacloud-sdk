...
use AlibabaCloud\SDK\ECI\V20180808\ECI\CreateContainerGroupRequest\dnsConfig;
use AlibabaCloud\SDK\ECI\V20180808\ECI\CreateContainerGroupRequest\securityContext;
...
class CreateContainerGroupRequest extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Tag'])) {
            if (!empty($map['Tag'])) {
                ...
                foreach ($map['Tag'] as $item) {
                    $model->tag[$n++] = null !== $item ? CreateContainerGroupRequest\tag::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['ImageRegistryCredential'])) {
            if (!empty($map['ImageRegistryCredential'])) {
                ...
                foreach ($map['ImageRegistryCredential'] as $item) {
                    $model->imageRegistryCredential[$n++] = null !== $item ? CreateContainerGroupRequest\imageRegistryCredential::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Container'])) {
            if (!empty($map['Container'])) {
                ...
                foreach ($map['Container'] as $item) {
                    $model->container[$n++] = null !== $item ? CreateContainerGroupRequest\container::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Volume'])) {
            if (!empty($map['Volume'])) {
                ...
                foreach ($map['Volume'] as $item) {
                    $model->volume[$n++] = null !== $item ? CreateContainerGroupRequest\volume::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['InitContainer'])) {
            if (!empty($map['InitContainer'])) {
                ...
                foreach ($map['InitContainer'] as $item) {
                    $model->initContainer[$n++] = null !== $item ? CreateContainerGroupRequest\initContainer::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['DnsConfig'])) {
            $model->dnsConfig = CreateContainerGroupRequest\dnsConfig::fromMap($map['DnsConfig']);
        }
        if (isset($map['Cpu'])) {
            $model->cpu = $map['Cpu'];
        }
        ...
        if (isset($map['HostAliase'])) {
            if (!empty($map['HostAliase'])) {
                ...
                foreach ($map['HostAliase'] as $item) {
                    $model->hostAliase[$n++] = null !== $item ? CreateContainerGroupRequest\hostAliase::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Arn'])) {
            if (!empty($map['Arn'])) {
                ...
                foreach ($map['Arn'] as $item) {
                    $model->arn[$n++] = null !== $item ? CreateContainerGroupRequest\arn::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['SecurityContext'])) {
            $model->securityContext = CreateContainerGroupRequest\securityContext::fromMap($map['SecurityContext']);
        }
