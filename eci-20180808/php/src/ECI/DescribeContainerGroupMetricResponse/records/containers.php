...
use AlibabaCloud\SDK\ECI\V20180808\ECI\containers\CPU;
use AlibabaCloud\SDK\ECI\V20180808\ECI\containers\memory;
...
class containers extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['CPU'])) {
            $model->CPU = containers\CPU::fromMap($map['CPU']);
        }
        if (isset($map['Memory'])) {
            $model->memory = containers\memory::fromMap($map['Memory']);
        }
