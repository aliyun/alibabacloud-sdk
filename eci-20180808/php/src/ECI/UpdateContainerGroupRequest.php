...
use AlibabaCloud\SDK\ECI\V20180808\ECI\UpdateContainerGroupRequest\dnsConfig;
        ...
        if (isset($map['Tag'])) {
            if (!empty($map['Tag'])) {
                ...
                foreach ($map['Tag'] as $item) {
                    $model->tag[$n++] = null !== $item ? UpdateContainerGroupRequest\tag::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Volume'])) {
            if (!empty($map['Volume'])) {
                ...
                foreach ($map['Volume'] as $item) {
                    $model->volume[$n++] = null !== $item ? UpdateContainerGroupRequest\volume::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['DnsConfig'])) {
            $model->dnsConfig = UpdateContainerGroupRequest\dnsConfig::fromMap($map['DnsConfig']);
        }
        if (isset($map['Container'])) {
            if (!empty($map['Container'])) {
                ...
                foreach ($map['Container'] as $item) {
                    $model->container[$n++] = null !== $item ? UpdateContainerGroupRequest\container::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['InitContainer'])) {
            if (!empty($map['InitContainer'])) {
                ...
                foreach ($map['InitContainer'] as $item) {
                    $model->initContainer[$n++] = null !== $item ? UpdateContainerGroupRequest\initContainer::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['ImageRegistryCredential'])) {
            if (!empty($map['ImageRegistryCredential'])) {
                ...
                foreach ($map['ImageRegistryCredential'] as $item) {
                    $model->imageRegistryCredential[$n++] = null !== $item ? UpdateContainerGroupRequest\imageRegistryCredential::fromMap($item) : $item;
                }
            }
        }
