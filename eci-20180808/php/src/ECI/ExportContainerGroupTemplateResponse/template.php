...
use AlibabaCloud\SDK\ECI\V20180808\ECI\template\resources;
use AlibabaCloud\SDK\ECI\V20180808\ECI\template\spec;
        ...
        if (isset($map['Tags'])) {
            if (!empty($map['Tags'])) {
                ...
                foreach ($map['Tags'] as $item) {
                    $model->tags[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\tags::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Resources'])) {
            $model->resources = template\resources::fromMap($map['Resources']);
        }
        if (isset($map['Spec'])) {
            $model->spec = template\spec::fromMap($map['Spec']);
        }
