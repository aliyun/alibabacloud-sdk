...
use AlibabaCloud\SDK\ECI\V20180808\ECI\containers\resources;
...
class containers extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Env'])) {
            if (!empty($map['Env'])) {
                ...
                foreach ($map['Env'] as $item) {
                    $model->env[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\containers\env::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Ports'])) {
            if (!empty($map['Ports'])) {
                ...
                foreach ($map['Ports'] as $item) {
                    $model->ports[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\containers\ports::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['VolumeMounts'])) {
            if (!empty($map['VolumeMounts'])) {
                ...
                foreach ($map['VolumeMounts'] as $item) {
                    $model->volumeMounts[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\containers\volumeMounts::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['Resources'])) {
            $model->resources = containers\resources::fromMap($map['Resources']);
        }
