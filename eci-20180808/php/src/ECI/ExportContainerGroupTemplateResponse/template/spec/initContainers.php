...
use AlibabaCloud\SDK\ECI\V20180808\ECI\initContainers\resources;
...
class initContainers extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Env'])) {
            if (!empty($map['Env'])) {
                ...
                foreach ($map['Env'] as $item) {
                    $model->env[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\initContainers\env::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Ports'])) {
            if (!empty($map['Ports'])) {
                ...
                foreach ($map['Ports'] as $item) {
                    $model->ports[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\initContainers\ports::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['VolumeMounts'])) {
            if (!empty($map['VolumeMounts'])) {
                ...
                foreach ($map['VolumeMounts'] as $item) {
                    $model->volumeMounts[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\initContainers\volumeMounts::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['Resources'])) {
            $model->resources = initContainers\resources::fromMap($map['Resources']);
        }
