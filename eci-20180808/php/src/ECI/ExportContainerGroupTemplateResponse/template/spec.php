...
use AlibabaCloud\SDK\ECI\V20180808\ECI\spec\dnsConfig;
use AlibabaCloud\SDK\ECI\V20180808\ECI\spec\securityContext;
        ...
        if (isset($map['Volumes'])) {
            if (!empty($map['Volumes'])) {
                ...
                foreach ($map['Volumes'] as $item) {
                    $model->volumes[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\volumes::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['InitContainers'])) {
            if (!empty($map['InitContainers'])) {
                ...
                foreach ($map['InitContainers'] as $item) {
                    $model->initContainers[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\initContainers::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Containers'])) {
            if (!empty($map['Containers'])) {
                ...
                foreach ($map['Containers'] as $item) {
                    $model->containers[$n++] = null !== $item ? ExportContainerGroupTemplateResponse\template\spec\containers::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['DnsConfig'])) {
            $model->dnsConfig = spec\dnsConfig::fromMap($map['DnsConfig']);
        }
        if (isset($map['SecurityContext'])) {
            $model->securityContext = spec\securityContext::fromMap($map['SecurityContext']);
        }
