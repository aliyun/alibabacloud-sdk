        ...
        if (isset($map['Records'])) {
            if (!empty($map['Records'])) {
                ...
                foreach ($map['Records'] as $item) {
                    $model->records[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\records::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['ContainerInfos'])) {
            if (!empty($map['ContainerInfos'])) {
                ...
                foreach ($map['ContainerInfos'] as $item) {
                    $model->containerInfos[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos::fromMap($item) : $item;
                }
            }
        }
