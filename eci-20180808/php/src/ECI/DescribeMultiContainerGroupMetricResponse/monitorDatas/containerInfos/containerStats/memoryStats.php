...
use AlibabaCloud\SDK\ECI\V20180808\ECI\memoryStats\containerData;
use AlibabaCloud\SDK\ECI\V20180808\ECI\memoryStats\hierarchicalData;
...
class memoryStats extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ContainerData'])) {
            $model->containerData = memoryStats\containerData::fromMap($map['ContainerData']);
        }
        if (isset($map['HierarchicalData'])) {
            $model->hierarchicalData = memoryStats\hierarchicalData::fromMap($map['HierarchicalData']);
        }
