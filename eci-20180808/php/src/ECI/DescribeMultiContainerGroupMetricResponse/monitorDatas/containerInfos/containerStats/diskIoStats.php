        ...
        if (isset($map['IoServiceBytes'])) {
            if (!empty($map['IoServiceBytes'])) {
                ...
                foreach ($map['IoServiceBytes'] as $item) {
                    $model->ioServiceBytes[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\ioServiceBytes::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['IoServiced'])) {
            if (!empty($map['IoServiced'])) {
                ...
                foreach ($map['IoServiced'] as $item) {
                    $model->ioServiced[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\ioServiced::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['IoQueued'])) {
            if (!empty($map['IoQueued'])) {
                ...
                foreach ($map['IoQueued'] as $item) {
                    $model->ioQueued[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\ioQueued::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Sectors'])) {
            if (!empty($map['Sectors'])) {
                ...
                foreach ($map['Sectors'] as $item) {
                    $model->sectors[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\sectors::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['IoServiceTime'])) {
            if (!empty($map['IoServiceTime'])) {
                ...
                foreach ($map['IoServiceTime'] as $item) {
                    $model->ioServiceTime[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\ioServiceTime::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['IoWaitTime'])) {
            if (!empty($map['IoWaitTime'])) {
                ...
                foreach ($map['IoWaitTime'] as $item) {
                    $model->ioWaitTime[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\ioWaitTime::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['IoMerged'])) {
            if (!empty($map['IoMerged'])) {
                ...
                foreach ($map['IoMerged'] as $item) {
                    $model->ioMerged[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\ioMerged::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['IoTime'])) {
            if (!empty($map['IoTime'])) {
                ...
                foreach ($map['IoTime'] as $item) {
                    $model->ioTime[$n++] = null !== $item ? DescribeMultiContainerGroupMetricResponse\monitorDatas\containerInfos\containerStats\diskIoStats\ioTime::fromMap($item) : $item;
                }
            }
        }
