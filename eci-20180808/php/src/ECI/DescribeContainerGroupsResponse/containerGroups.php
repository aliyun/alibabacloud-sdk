...
use AlibabaCloud\SDK\ECI\V20180808\ECI\containerGroups\dnsConfig;
use AlibabaCloud\SDK\ECI\V20180808\ECI\containerGroups\eciSecurityContext;
        ...
        if (isset($map['Tags'])) {
            if (!empty($map['Tags'])) {
                ...
                foreach ($map['Tags'] as $item) {
                    $model->tags[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\tags::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Events'])) {
            if (!empty($map['Events'])) {
                ...
                foreach ($map['Events'] as $item) {
                    $model->events[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\events::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Containers'])) {
            if (!empty($map['Containers'])) {
                ...
                foreach ($map['Containers'] as $item) {
                    $model->containers[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\containers::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Volumes'])) {
            if (!empty($map['Volumes'])) {
                ...
                foreach ($map['Volumes'] as $item) {
                    $model->volumes[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\volumes::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['InitContainers'])) {
            if (!empty($map['InitContainers'])) {
                ...
                foreach ($map['InitContainers'] as $item) {
                    $model->initContainers[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\initContainers::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['HostAliases'])) {
            if (!empty($map['HostAliases'])) {
                ...
                foreach ($map['HostAliases'] as $item) {
                    $model->hostAliases[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\hostAliases::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['DnsConfig'])) {
            $model->dnsConfig = containerGroups\dnsConfig::fromMap($map['DnsConfig']);
        }
        if (isset($map['EciSecurityContext'])) {
            $model->eciSecurityContext = containerGroups\eciSecurityContext::fromMap($map['EciSecurityContext']);
        }
