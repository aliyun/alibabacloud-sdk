...
use AlibabaCloud\SDK\ECI\V20180808\ECI\initContainers\currentState;
use AlibabaCloud\SDK\ECI\V20180808\ECI\initContainers\previousState;
use AlibabaCloud\SDK\ECI\V20180808\ECI\initContainers\securityContext;
        ...
        if (isset($map['VolumeMounts'])) {
            if (!empty($map['VolumeMounts'])) {
                ...
                foreach ($map['VolumeMounts'] as $item) {
                    $model->volumeMounts[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\initContainers\volumeMounts::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Ports'])) {
            if (!empty($map['Ports'])) {
                ...
                foreach ($map['Ports'] as $item) {
                    $model->ports[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\initContainers\ports::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['EnvironmentVars'])) {
            if (!empty($map['EnvironmentVars'])) {
                ...
                foreach ($map['EnvironmentVars'] as $item) {
                    $model->environmentVars[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\initContainers\environmentVars::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['PreviousState'])) {
            $model->previousState = initContainers\previousState::fromMap($map['PreviousState']);
        }
        if (isset($map['CurrentState'])) {
            $model->currentState = initContainers\currentState::fromMap($map['CurrentState']);
        }
        if (isset($map['SecurityContext'])) {
            $model->securityContext = initContainers\securityContext::fromMap($map['SecurityContext']);
        }
