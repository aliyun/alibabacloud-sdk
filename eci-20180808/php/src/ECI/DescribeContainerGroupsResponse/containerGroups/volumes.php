        ...
        if (isset($map['ConfigFileVolumeConfigFileToPaths'])) {
            if (!empty($map['ConfigFileVolumeConfigFileToPaths'])) {
                ...
                foreach ($map['ConfigFileVolumeConfigFileToPaths'] as $item) {
                    $model->configFileVolumeConfigFileToPaths[$n++] = null !== $item ? DescribeContainerGroupsResponse\containerGroups\volumes\configFileVolumeConfigFileToPaths::fromMap($item) : $item;
                }
            }
        }
