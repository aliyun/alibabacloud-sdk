...
use AlibabaCloud\SDK\ECI\V20180808\ECI\initContainer\securityContext;
        ...
        if (isset($map['VolumeMount'])) {
            if (!empty($map['VolumeMount'])) {
                ...
                foreach ($map['VolumeMount'] as $item) {
                    $model->volumeMount[$n++] = null !== $item ? CreateContainerGroupRequest\initContainer\volumeMount::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Port'])) {
            if (!empty($map['Port'])) {
                ...
                foreach ($map['Port'] as $item) {
                    $model->port[$n++] = null !== $item ? CreateContainerGroupRequest\initContainer\port::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['EnvironmentVar'])) {
            if (!empty($map['EnvironmentVar'])) {
                ...
                foreach ($map['EnvironmentVar'] as $item) {
                    $model->environmentVar[$n++] = null !== $item ? CreateContainerGroupRequest\initContainer\environmentVar::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['SecurityContext'])) {
            $model->securityContext = initContainer\securityContext::fromMap($map['SecurityContext']);
        }
        if (isset($map['Gpu'])) {
            $model->gpu = $map['Gpu'];
        }
