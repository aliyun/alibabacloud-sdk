...
use AlibabaCloud\SDK\ECI\V20180808\ECI\readinessProbe\exec;
use AlibabaCloud\SDK\ECI\V20180808\ECI\readinessProbe\httpGet;
use AlibabaCloud\SDK\ECI\V20180808\ECI\readinessProbe\tcpSocket;
...
class readinessProbe extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['HttpGet'])) {
            $model->httpGet = readinessProbe\httpGet::fromMap($map['HttpGet']);
        }
        ...
        if (isset($map['Exec'])) {
            $model->exec = readinessProbe\exec::fromMap($map['Exec']);
        }
        if (isset($map['TcpSocket'])) {
            $model->tcpSocket = readinessProbe\tcpSocket::fromMap($map['TcpSocket']);
        }
