...
namespace AlibabaCloud.SDK.Goodstech20191230
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public RecognizeFurnitureAttributeResponse RecognizeFurnitureAttribute(RecognizeFurnitureAttributeRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<RecognizeFurnitureAttributeResponse>(DoRequest("RecognizeFurnitureAttribute", "HTTPS", "POST", "2019-12-30", "AK", null, request.ToMap(), runtime));
        }

        public async Task<RecognizeFurnitureAttributeResponse> RecognizeFurnitureAttributeAsync(RecognizeFurnitureAttributeRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<RecognizeFurnitureAttributeResponse>(await DoRequestAsync("RecognizeFurnitureAttribute", "HTTPS", "POST", "2019-12-30", "AK", null, request.ToMap(), runtime));
        }
        ...
        public RecognizeFurnitureAttributeResponse RecognizeFurnitureAttributeAdvance(RecognizeFurnitureAttributeAdvanceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            AlibabaCloud.Commons.Common.Convert(request, recognizeFurnitureAttributereq);
            recognizeFurnitureAttributereq.ImageURL = "http://" + authResponse.Bucket + "." + authResponse.Endpoint + "/" + authResponse.ObjectKey;
            RecognizeFurnitureAttributeResponse recognizeFurnitureAttributeResp = RecognizeFurnitureAttribute(recognizeFurnitureAttributereq, runtime);
        ...
        public async Task<RecognizeFurnitureAttributeResponse> RecognizeFurnitureAttributeAdvanceAsync(RecognizeFurnitureAttributeAdvanceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            AlibabaCloud.Commons.Common.Convert(request, recognizeFurnitureAttributereq);
            recognizeFurnitureAttributereq.ImageURL = "http://" + authResponse.Bucket + "." + authResponse.Endpoint + "/" + authResponse.ObjectKey;
            RecognizeFurnitureAttributeResponse recognizeFurnitureAttributeResp = await RecognizeFurnitureAttributeAsync(recognizeFurnitureAttributereq, runtime);
            return recognizeFurnitureAttributeResp;
        }

        public RecognizeFurnitureSpuResponse RecognizeFurnitureSpu(RecognizeFurnitureSpuRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<RecognizeFurnitureSpuResponse>(DoRequest("RecognizeFurnitureSpu", "HTTPS", "POST", "2019-12-30", "AK", null, request.ToMap(), runtime));
        }

        public async Task<RecognizeFurnitureSpuResponse> RecognizeFurnitureSpuAsync(RecognizeFurnitureSpuRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<RecognizeFurnitureSpuResponse>(await DoRequestAsync("RecognizeFurnitureSpu", "HTTPS", "POST", "2019-12-30", "AK", null, request.ToMap(), runtime));
        }
        ...
        public RecognizeFurnitureSpuResponse RecognizeFurnitureSpuAdvance(RecognizeFurnitureSpuAdvanceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            AlibabaCloud.Commons.Common.Convert(request, recognizeFurnitureSpureq);
            recognizeFurnitureSpureq.ImageURL = "http://" + authResponse.Bucket + "." + authResponse.Endpoint + "/" + authResponse.ObjectKey;
            RecognizeFurnitureSpuResponse recognizeFurnitureSpuResp = RecognizeFurnitureSpu(recognizeFurnitureSpureq, runtime);
        ...
        public async Task<RecognizeFurnitureSpuResponse> RecognizeFurnitureSpuAdvanceAsync(RecognizeFurnitureSpuAdvanceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            AlibabaCloud.Commons.Common.Convert(request, recognizeFurnitureSpureq);
            recognizeFurnitureSpureq.ImageURL = "http://" + authResponse.Bucket + "." + authResponse.Endpoint + "/" + authResponse.ObjectKey;
            RecognizeFurnitureSpuResponse recognizeFurnitureSpuResp = await RecognizeFurnitureSpuAsync(recognizeFurnitureSpureq, runtime);
            return recognizeFurnitureSpuResp;
        }

        public ClassifyCommodityResponse ClassifyCommodity(ClassifyCommodityRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ClassifyCommodityResponse>(DoRequest("ClassifyCommodity", "HTTPS", "GET", "2019-12-30", "AK", request.ToMap(), null, runtime));
        }

        public async Task<ClassifyCommodityResponse> ClassifyCommodityAsync(ClassifyCommodityRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ClassifyCommodityResponse>(await DoRequestAsync("ClassifyCommodity", "HTTPS", "GET", "2019-12-30", "AK", request.ToMap(), null, runtime));
        }
