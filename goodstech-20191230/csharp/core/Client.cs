...
namespace AlibabaCloud.Goodstech
{
    public class Client 
    {
        ...
        {
            return TeaModel.ToObject<RecognizeFurnitureAttributeResponse>(_request("RecognizeFurnitureAttribute", "HTTPS", "POST", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<RecognizeFurnitureAttributeResponse>(await _requestAsync("RecognizeFurnitureAttribute", "HTTPS", "POST", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<RecognizeFurnitureSpuResponse>(_request("RecognizeFurnitureSpu", "HTTPS", "POST", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<RecognizeFurnitureSpuResponse>(await _requestAsync("RecognizeFurnitureSpu", "HTTPS", "POST", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            return TeaModel.ToObject<ClassifyCommodityResponse>(_request("ClassifyCommodity", "HTTPS", "GET", "AK", request.ToMap(), null, runtime));
        }
        ...
        {
            return TeaModel.ToObject<ClassifyCommodityResponse>(await _requestAsync("ClassifyCommodity", "HTTPS", "GET", "AK", request.ToMap(), null, runtime));
        }
