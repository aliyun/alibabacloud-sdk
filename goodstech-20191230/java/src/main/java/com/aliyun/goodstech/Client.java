...
public class Client extends RPCClient {
    ...
    public ClassifyCommodityResponse classifyCommodity(ClassifyCommodityRequest request, com.aliyun.common.models.RuntimeObject runtime) throws Exception {
    ...
    public ClassifyCommodityResponse classifyCommodityAdvance(ClassifyCommodityAdvanceRequest request, com.aliyun.common.models.RuntimeObject runtime) throws Exception {
