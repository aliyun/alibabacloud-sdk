...
use AlibabaCloud\SDK\Ecs\V20140526\Models\DescribePriceResponse\priceInfo\price\detailInfos;
...
class price extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('reservedInstanceHourPrice', $this->reservedInstanceHourPrice, true);
