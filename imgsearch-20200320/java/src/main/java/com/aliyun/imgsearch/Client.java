...
package com.aliyun.imgsearch;

import com.aliyun.tea.*;
import com.aliyun.imgsearch.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.headers = TeaConverter.buildMap(
                    new TeaPair("host", com.aliyun.common.Common.getHost("imgsearch", _regionId, _endpoint)),
    ...
    public ListImageDbsResponse listImageDbs(ListImageDbsRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("ListImageDbs", "HTTPS", "GET", "AK", null, TeaModel.buildMap(request), runtime), new ListImageDbsResponse());
    }
    ...
    public ListImagesResponse listImages(ListImagesRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("ListImages", "HTTPS", "GET", "AK", null, TeaModel.buildMap(request), runtime), new ListImagesResponse());
    }
    ...
    public SearchImageResponse searchImage(SearchImageRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("SearchImage", "HTTPS", "GET", "AK", null, TeaModel.buildMap(request), runtime), new SearchImageResponse());
    }
    ...
    public AddImageResponse addImage(AddImageRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("AddImage", "HTTPS", "GET", "AK", null, TeaModel.buildMap(request), runtime), new AddImageResponse());
    }
    ...
    public DeleteImageDbResponse deleteImageDb(DeleteImageDbRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("DeleteImageDb", "HTTPS", "GET", "AK", null, TeaModel.buildMap(request), runtime), new DeleteImageDbResponse());
    }
    ...
    public CreateImageDbResponse createImageDb(CreateImageDbRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("CreateImageDb", "HTTPS", "GET", "AK", null, TeaModel.buildMap(request), runtime), new CreateImageDbResponse());
    }
    ...
    public DeleteImageResponse deleteImage(DeleteImageRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("DeleteImage", "HTTPS", "GET", "AK", null, TeaModel.buildMap(request), runtime), new DeleteImageResponse());
    }
