...
use AlibabaCloud\SDK\Imgsearch\V20200320\Imgsearch\Config;
...
class Imgsearch
{
    ...
    public function _request($action, $protocol, $method, $authType, $query, $body, RuntimeOptions $runtime)
    {
        ...
        while (Tea::allowRetry($_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->headers = [
                    'host'       => RpcUtils::getHost('imgsearch', $this->_regionId, $this->_endpoint),
    ...
    {
        return Model::toModel($this->_request('ListImageDbs', 'HTTPS', 'GET', 'AK', null, $request, $runtime), new ListImageDbsResponse());
    }
    ...
    {
        return Model::toModel($this->_request('ListImages', 'HTTPS', 'GET', 'AK', null, $request, $runtime), new ListImagesResponse());
    }
    ...
    {
        return Model::toModel($this->_request('SearchImage', 'HTTPS', 'GET', 'AK', null, $request, $runtime), new SearchImageResponse());
    }
    ...
    {
        return Model::toModel($this->_request('AddImage', 'HTTPS', 'GET', 'AK', null, $request, $runtime), new AddImageResponse());
    }
    ...
    {
        return Model::toModel($this->_request('DeleteImageDb', 'HTTPS', 'GET', 'AK', null, $request, $runtime), new DeleteImageDbResponse());
    }
    ...
    {
        return Model::toModel($this->_request('CreateImageDb', 'HTTPS', 'GET', 'AK', null, $request, $runtime), new CreateImageDbResponse());
    }
    ...
    {
        return Model::toModel($this->_request('DeleteImage', 'HTTPS', 'GET', 'AK', null, $request, $runtime), new DeleteImageResponse());
    }
