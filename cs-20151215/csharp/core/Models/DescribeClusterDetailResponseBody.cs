...
namespace AlibabaCloud.SDK.CS20151215.Models
{
    public class DescribeClusterDetailResponseBody : TeaModel {
        ...
        [Validation(Required=true)]
        public DescribeClusterDetailResponseBodyUpgradeComponents UpgradeComponents { get; set; }
        public class DescribeClusterDetailResponseBodyUpgradeComponents : TeaModel {
            [NameInMap("Kubernetes")]
            [Validation(Required=true)]
            public DescribeClusterDetailResponseBodyUpgradeComponentsKubernetes Kubernetes { get; set; }
            public class DescribeClusterDetailResponseBodyUpgradeComponentsKubernetes : TeaModel {
        ...
        [Validation(Required=true)]
        public DescribeClusterDetailResponseBodyParameters Parameters { get; set; }
        public class DescribeClusterDetailResponseBodyParameters : TeaModel {
