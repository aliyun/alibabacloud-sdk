...
URL = "https://github.com/aliyun/alibabacloud-sdk/tree/master/cs-20151215/python"

TOPDIR = os.path.dirname(__file__) or "."
VERSION = __import__(PACKAGE).__version__
REQUIRES = ["alibabacloud_tea_util>=0.0.2", "alibabacloud_tea_roa>=0.0.6", "alibabacloud_endpoint_util>=0.0.2"]
