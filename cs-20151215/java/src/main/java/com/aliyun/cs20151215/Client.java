...
public class Client extends com.aliyun.tearoa.Client {
    ...
    public DeleteTriggerHookResponse deleteTriggerHookWithOptions(DeleteTriggerHookRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("2015-12-15", "HTTPS", "POST", "AK", "/api/v2/hook/trigger", null, request.headers, null, runtime), new DeleteTriggerHookResponse());
    }

    public DeleteTriggerHookResponse deleteTriggerHook(DeleteTriggerHookRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
    ...
    public CreateTriggerHookResponse createTriggerHookWithOptions(CreateTriggerHookRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        com.aliyun.teautil.Common.validateModel(request);
        return TeaModel.toModel(this.doRequest("2015-12-15", "HTTPS", "PUT", "AK", "/hook/trigger", null, request.headers, TeaModel.buildMap(request.body), runtime), new CreateTriggerHookResponse());
    }

    public CreateTriggerHookResponse createTriggerHook(CreateTriggerHookRequest request) throws Exception {
        com.aliyun.teautil.models.RuntimeOptions runtime = new com.aliyun.teautil.models.RuntimeOptions();
