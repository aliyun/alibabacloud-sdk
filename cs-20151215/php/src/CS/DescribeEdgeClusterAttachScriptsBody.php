...
use AlibabaCloud\SDK\CS\V20151215\CS\DescribeEdgeClusterAttachScriptsBody\options;
...
class DescribeEdgeClusterAttachScriptsBody extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['options'])) {
            $model->options = DescribeEdgeClusterAttachScriptsBody\options::fromMap($map['options']);
        }
