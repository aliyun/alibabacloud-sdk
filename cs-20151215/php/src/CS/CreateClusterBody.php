...
class CreateClusterBody extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('endpointPublicAccess', $this->endpointPublicAccess, true);
        ...
        Model::validateRequired('nodePortRange', $this->nodePortRange, true);
        ...
        Model::validateRequired('timeoutMins', $this->timeoutMins, true);
        ...
        if (isset($map['tags'])) {
            if (!empty($map['tags'])) {
                ...
                foreach ($map['tags'] as $item) {
                    $model->tags[$n++] = null !== $item ? CreateClusterBody\tags::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['addons'])) {
            if (!empty($map['addons'])) {
                ...
                foreach ($map['addons'] as $item) {
                    $model->addons[$n++] = null !== $item ? CreateClusterBody\addons::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['taints'])) {
            if (!empty($map['taints'])) {
                ...
                foreach ($map['taints'] as $item) {
                    $model->taints[$n++] = null !== $item ? CreateClusterBody\taints::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['worker_data_disks'])) {
            if (!empty($map['worker_data_disks'])) {
                ...
                foreach ($map['worker_data_disks'] as $item) {
                    $model->workerDataDisks[$n++] = null !== $item ? CreateClusterBody\workerDataDisks::fromMap($item) : $item;
                }
            }
        }
