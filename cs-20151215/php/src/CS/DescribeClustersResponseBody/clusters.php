...
use AlibabaCloud\SDK\CS\V20151215\CS\clusters\parameters;
use AlibabaCloud\SDK\CS\V20151215\CS\clusters\upgradeComponents;
...
class clusters extends Model
{
     ...
     *
     * @var clusters.upgradeComponents
     */
    public $upgradeComponents;
    /**
     * @description parameters
     *
     * @var clusters.parameters
     */
    public $parameters;
    protected $_name = [
        'name'                   => 'name',
        ...
        if (isset($map['tags'])) {
            if (!empty($map['tags'])) {
                ...
                foreach ($map['tags'] as $item) {
                    $model->tags[$n++] = null !== $item ? DescribeClustersResponseBody\clusters\tags::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['outputs'])) {
            if (!empty($map['outputs'])) {
                ...
                foreach ($map['outputs'] as $item) {
                    $model->outputs[$n++] = null !== $item ? DescribeClustersResponseBody\clusters\outputs::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['upgrade_components'])) {
            $model->upgradeComponents = clusters\upgradeComponents::fromMap($map['upgrade_components']);
        }
        if (isset($map['parameters'])) {
            $model->parameters = clusters\parameters::fromMap($map['parameters']);
        }
