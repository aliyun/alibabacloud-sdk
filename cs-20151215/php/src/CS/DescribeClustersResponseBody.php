...
use AlibabaCloud\SDK\CS\V20151215\CS\DescribeClustersResponseBody\parameters;
use AlibabaCloud\SDK\CS\V20151215\CS\DescribeClustersResponseBody\upgradeComponents;
...
class DescribeClustersResponseBody extends Model
{
     ...
     *
     * @var DescribeClustersResponseBody.parameters
     */
    public $parameters;
    protected $_name = [
        'name'                   => 'name',
        ...
        if (isset($map['tags'])) {
            if (!empty($map['tags'])) {
                ...
                foreach ($map['tags'] as $item) {
                    $model->tags[$n++] = null !== $item ? DescribeClustersResponseBody\tags::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['outputs'])) {
            if (!empty($map['outputs'])) {
                ...
                foreach ($map['outputs'] as $item) {
                    $model->outputs[$n++] = null !== $item ? DescribeClustersResponseBody\outputs::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['upgrade_components'])) {
            $model->upgradeComponents = DescribeClustersResponseBody\upgradeComponents::fromMap($map['upgrade_components']);
        }
        if (isset($map['parameters'])) {
            $model->parameters = DescribeClustersResponseBody\parameters::fromMap($map['parameters']);
        }
