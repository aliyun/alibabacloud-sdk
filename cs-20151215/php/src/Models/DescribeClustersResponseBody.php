...
use AlibabaCloud\SDK\CS\V20151215\Models\DescribeClustersResponseBody\outputs;
use AlibabaCloud\SDK\CS\V20151215\Models\DescribeClustersResponseBody\parameters;
use AlibabaCloud\SDK\CS\V20151215\Models\DescribeClustersResponseBody\tags;
use AlibabaCloud\SDK\CS\V20151215\Models\DescribeClustersResponseBody\upgradeComponents;
...
class DescribeClustersResponseBody extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['upgrade_components'])) {
            $model->upgradeComponents = upgradeComponents::fromMap($map['upgrade_components']);
        }
