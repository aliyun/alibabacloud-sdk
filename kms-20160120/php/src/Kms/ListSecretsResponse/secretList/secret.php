...
namespace AlibabaCloud\SDK\Kms\V20160120\Kms\ListSecretsResponse\secretList;

use AlibabaCloud\SDK\Kms\V20160120\Kms\secret\tags;
...
class secret extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Tags'])) {
            $model->tags = secret\tags::fromMap($map['Tags']);
        }
