...
namespace AlibabaCloud\SDK\Kms\V20160120\Kms\ListKeyVersionsResponse;
        ...
        if (isset($map['KeyVersion'])) {
            if (!empty($map['KeyVersion'])) {
                ...
                foreach ($map['KeyVersion'] as $item) {
                    $model->keyVersion[$n++] = null !== $item ? ListKeyVersionsResponse\keyVersions\keyVersion::fromMap($item) : $item;
                }
            }
        }
