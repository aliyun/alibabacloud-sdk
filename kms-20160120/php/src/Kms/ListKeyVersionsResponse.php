...
use AlibabaCloud\SDK\Kms\V20160120\Kms\ListKeyVersionsResponse\keyVersions;
...
class ListKeyVersionsResponse extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['KeyVersions'])) {
            $model->keyVersions = ListKeyVersionsResponse\keyVersions::fromMap($map['KeyVersions']);
        }
