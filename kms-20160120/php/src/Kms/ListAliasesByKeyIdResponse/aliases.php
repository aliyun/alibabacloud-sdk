...
namespace AlibabaCloud\SDK\Kms\V20160120\Kms\ListAliasesByKeyIdResponse;
        ...
        if (isset($map['Alias'])) {
            if (!empty($map['Alias'])) {
                ...
                foreach ($map['Alias'] as $item) {
                    $model->alias[$n++] = null !== $item ? ListAliasesByKeyIdResponse\aliases\alias::fromMap($item) : $item;
                }
            }
        }
