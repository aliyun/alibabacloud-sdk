...
use AlibabaCloud\SDK\Videorecog\V20200320\Videorecog\Config;
...
class Videorecog
{
    ...
    public function _request($action, $protocol, $method, $authType, $query, $body, RuntimeOptions $runtime)
    {
        ...
        while (Tea::allowRetry($_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $_request->headers = [
                    'host'       => RpcUtils::getHost('videorecog', $this->_regionId, $this->_endpoint),
    ...
    {
        return Model::toModel($this->_request('DetectVideoShot', 'HTTPS', 'POST', 'AK', null, $request, $runtime), new DetectVideoShotResponse());
    }
    ...
    {
        return Model::toModel($this->_request('GenerateVideoCover', 'HTTPS', 'POST', 'AK', null, $request, $runtime), new GenerateVideoCoverResponse());
    }
