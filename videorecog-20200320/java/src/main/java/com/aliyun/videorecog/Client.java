...
package com.aliyun.videorecog;

import com.aliyun.tea.*;
import com.aliyun.videorecog.models.*;
...
public class Client {
        ...
        while (Tea.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                request_.headers = TeaConverter.buildMap(
                    new TeaPair("host", com.aliyun.common.Common.getHost("videorecog", _regionId, _endpoint)),
    ...
    public DetectVideoShotResponse detectVideoShot(DetectVideoShotRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("DetectVideoShot", "HTTPS", "POST", "AK", null, TeaModel.buildMap(request), runtime), new DetectVideoShotResponse());
    }
    ...
    public GenerateVideoCoverResponse generateVideoCover(GenerateVideoCoverRequest request, com.aliyun.teautil.models.RuntimeOptions runtime) throws Exception {
        return TeaModel.toModel(this._request("GenerateVideoCover", "HTTPS", "POST", "AK", null, TeaModel.buildMap(request), runtime), new GenerateVideoCoverResponse());
    }
