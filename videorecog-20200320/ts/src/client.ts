...
export default class Client {
  ...
  async _request(action: string, protocol: string, method: string, authType: string, query: {[key: string]: any}, body: {[key: string]: any}, runtime: $Util.RuntimeOptions): Promise<{[key: string]: any}> {
    ...
    while ($tea.allowRetry(_runtime['retry'], _retryTimes, _now)) {
      ...
      try {
        ...
        request_.headers = {
          host: RPCUtil.getHost("videorecog", this._regionId, this._endpoint),
  ...
  async detectVideoShot(request: DetectVideoShotRequest, runtime: $Util.RuntimeOptions): Promise<DetectVideoShotResponse> {
    return $tea.cast<DetectVideoShotResponse>(await this._request("DetectVideoShot", "HTTPS", "POST", "AK", null, $tea.toMap(request), runtime), new DetectVideoShotResponse({}));
  }
  ...
  async generateVideoCover(request: GenerateVideoCoverRequest, runtime: $Util.RuntimeOptions): Promise<GenerateVideoCoverResponse> {
    return $tea.cast<GenerateVideoCoverResponse>(await this._request("GenerateVideoCover", "HTTPS", "POST", "AK", null, $tea.toMap(request), runtime), new GenerateVideoCoverResponse({}));
  }
