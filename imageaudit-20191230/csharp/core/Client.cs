...
namespace AlibabaCloud.Imageaudit
{
    public class Client 
    {
        ...
        public ScanTextResponse ScanText(ScanTextRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            return TeaModel.ToObject<ScanTextResponse>(_request("ScanText", "HTTPS", "POST", request.ToMap(), runtime));
        }

        public async Task<ScanTextResponse> ScanTextAsync(ScanTextRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            return TeaModel.ToObject<ScanTextResponse>(await _requestAsync("ScanText", "HTTPS", "POST", request.ToMap(), runtime));
        }

        public ScanImageResponse ScanImage(ScanImageRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            return TeaModel.ToObject<ScanImageResponse>(_request("ScanImage", "HTTPS", "POST", request.ToMap(), runtime));
        }

        public async Task<ScanImageResponse> ScanImageAsync(ScanImageRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
